...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://youtube.com/@rampageraja")
                  ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ', url="https://t.me/rampagebackup")
        ],[
        ...
        await query.message.edit_text(
            ...
            cnlbtn = [[
                      InlineKeyboardButton('ᴄʜᴀɴɴᴇʟ', url='t.me/rampagebackup')
                     ], [
                      InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='t.me/rampagebackup'),
                      InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='t.me/rampagebackup')
                     ], [
                      InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="start")
                     ]]
...
async def advantage_spell_chok(msg):
    ...
    btn = [[
        ...
        InlineKeyboardButton(
            text="ʀᴇᴘᴏʀᴛ ʜᴇʀᴇ",
            url=f"https://t.me/theamanchaudhary{SUPPORT_CHAT}"
        )
    ],[
        InlineKeyboardButton(
